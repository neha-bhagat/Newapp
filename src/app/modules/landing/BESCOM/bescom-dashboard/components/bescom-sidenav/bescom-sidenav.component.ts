...
@Component({
  selector: 'app-bescom-sidenav',
  templateUrl: './bescom-sidenav.component.html',
  styleUrls: ['./bescom-sidenav.component.scss'],
})
export class BescomSidenavComponent {
  countdown: number = 5;
  imageurl:string;
  title:string;
  user:any
